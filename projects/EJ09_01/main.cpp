...
void render(const Geometry& floor, const Geometry& object, const Geometry& light, const Shader& s_phong, const Shader& s_light,
    ...
    glm::vec3 lightPos_Move = { 4.0f * glm::cos(time * glm::radians(10.0f)), 4.0f * glm::sin(time * glm::radians(10.0f)) , 0.0f };
    model = glm::translate(model, lightPos_Move);
    ...
    s_phong.set("light.position", lightPos_Move);
