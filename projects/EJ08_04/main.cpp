...
int main(int, char* []) {
    ...
    const Shader s_phong("../projects/AG08_02/phong.vs", "../projects/EJ08_04/blinn.fs");
    const Shader s_light("../projects/AG08_02/light.vs", "../projects/AG08_02/light.fs");
    const Texture t_albedo("../assets/textures/bricks_albedo.png", Texture::Format::RGB);
    const Texture t_specular("../assets/textures/bricks_specular.png", Texture::Format::RGB);
    const Texture t_emisive("../assets/textures/emissive.jpg", Texture::Format::RGB);
    ...
    while (window->alive()) {
        ...
        render(sphere, sphere, s_phong, s_light, t_albedo, t_specular, t_emisive);
        window->frame();
    }
